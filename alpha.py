...
Engine 2: Early Momentum (M15) — Volume Anomaly + Accumulation (OPTIMIZED)
...
# =================================================================
# 2. PRESETS & SUPABASE HELPERS (TRAILING SPACES DIBUANG)
# =================================================================
PRESETS = {
...
# =================================================================
# 5. ENGINE 2: M15 FAST-TRACK SNIPER (OPTIMIZED FOR SPEED & SHARPNESS)
# =================================================================
def analyze_early_momentum(sym, verbose=True):
    ...
    # 1. MICRO-TREND FILTER (Elak Counter-Trend yang bahaya)
    ...
    if ema20 < ema50 or current_price < ema20:
        return None  # Skip jika M15 sedang downtrend

    # 2. VOLUME ANOMALY (Dikurangkan dari 3.0x ke 2.0x untuk lebih signal tajam)
    ...
    # 3. ACCUMULATION PATTERN (Dilembutkan dari 5% ke 8%)
    ...
    # 5. KIRA SL & TP (Tight & Aggressive untuk M15)
    entry = curr['c']
...
# =================================================================
# 11. MAIN ENTRY POINT (SYNTAX DIPERBETULKAN)
# =================================================================
