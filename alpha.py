...
# ==========================================
# 3. TELEGRAM ENGINE (UPDATED FOR INLINE KEYBOARD)
# ==========================================
...
# ==========================================
# 6. ADVANCED SIGNAL FORMATTER WITH INLINE KEYBOARD
# ==========================================
class SignalFormatter:
    ...
    def build_inline_keyboard(chain, pool_address, token_address):
        """Smart Inline Keyboard based on Chain"""
        keyboard = []
    ...
    def format_premium_signal(symbol, chain, price, vwap, sl, tp1, tp2, tp3, pool_address):
        """Format signal dengan TP1/2/3 dan Inline Keyboard"""
        ts = datetime.utcnow().strftime("%Y-%m-%d %H:%M UTC")
        chain_display = SignalFormatter.get_chain_display_name(chain)
        token_address = pool_address # Simplification: using pool address as CA for deep links
