...
# =================================================================
# 6. ENGINE 1: PULLBACK SMC (H1 + H4) - 3 FILTER DIBUANG
# =================================================================
def analyze_smc_pa(sym, verbose=True):
    ...
    if len(candles_h4) >= 20:
        ...
        # FILTER 1 DIBUANG: H4 DOWNTREND TIDAK LAGI BLOCK, HANYA WARNING
    ...
    # FILTER 2 DIBUANG: EMA20 < EMA50 TIDAK LAGI BLOCK, HANYA WARNING
    if not is_uptrend:
...
# =================================================================
# 8. SIGNAL GENERATOR (BALANCED PREMIUM FORMAT) - FILTER 3 DIBUANG
# =================================================================
IS_SCANNING = True
WATCHLIST = {}
PULLBACK_WATCHLIST = {}
...
def send_signal(sym, smc_data, vol_24h, btc_chg=0.0):
    ...
    # FILTER 3 DIBUANG: PRICE GAP THRESHOLD TIDAK LAGI BLOCK SIGNAL
        ...
        if SCAN_MODE in ["momentum", "both"]:
            if t in momentum_candidates:
                ...
                if len(candles_h1) >= 20:
                    ...
                    if candles_h1[-1]['c'] < h1_ema20 * 0.85:
                        continue
...
def cmd_start(msg):
    ...
    text = (
        f"🏴‍☠️ <b>ALPHA — Dual Engine Sniper (HIGH SIGNAL)</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━\n"
...
class RenderHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"ALPHA HIGH SIGNAL ACTIVE")
